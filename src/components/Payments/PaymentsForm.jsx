          ...
          {isProviderSelected && (
            <>
                    ...
                    <HStack>
                      ...
                      >
                        ...
                        <option
                          value={"checkOwn"}
                          selected={
                            allCharges[index].paymentMethod === "checkOwn"
                          }
                        >
                          Cheque Propio
                        </option>
                      ...
                      {typeRemito === "checkOwn" ? (
                        <Select
                          {...register(`payments.${index}.check_id`)}
                          variant="flushed"
                        ...
                        <>
                          ...
                          {typeRemito === "check" && (
                            <>
                              <Input
                                {...register(`payments.${index}.checkNumber`)}
                                variant="flushed"
                          ...
                          {typeRemito === "others" && (
                            <Input
                              {...register(`payments.${index}.commentOthers`)}
                              variant="flushed"
              ...
              <Button
                ...
                fontSize="md"
                onClick={() =>
                  append({ paymentMethod: allCharges[0]?.paymentMethod })
                }
              >
                Agregar Pago
              </Button>
